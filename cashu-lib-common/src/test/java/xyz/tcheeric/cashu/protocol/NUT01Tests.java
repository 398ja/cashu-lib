...
/**
 * Compliance checks for NUT-01 key map serialization rules.
 */
class NUT01Tests {

    private static final ObjectMapper OBJECT_MAPPER = JsonUtils.JSON_MAPPER;

    /**
     * Ensures malformed key maps with invalid lengths are rejected.
     */
    @Test
    void shouldRejectKeysWithInvalidLength() {
        // Arrange
        ...
        Executable parseInvalidLength = () -> OBJECT_MAPPER.readValue(invalidLengthJson, Keys.class);

        // Act & Assert
        assertThrows(IllegalArgumentException.class, parseInvalidLength);
    }

    /**
     * Ensures malformed key maps with invalid formatting are rejected.
     */
    @Test
    void shouldRejectKeysWithInvalidFormat() {
        // Arrange
        ...
        Executable parseInvalidFormat = () -> OBJECT_MAPPER.readValue(invalidFormatJson, Keys.class);

        // Act & Assert
        assertThrows(IllegalArgumentException.class, parseInvalidFormat);
    }

    /**
     * Ensures valid key maps from the specification parse correctly.
     */
    @Test
    void shouldParseValidKeyMaps() {
        // Arrange
        String smallVector = """
                {
                  "1":"03a40f20667ed53513075dc51e715ff2046cad64eb68960632269ba7f0210e38bc",
        ...
        // Act & Assert
        assertDoesNotThrow(() -> OBJECT_MAPPER.readValue(smallVector, Keys.class));
        assertDoesNotThrow(() -> OBJECT_MAPPER.readValue(largeVector, Keys.class));
    }
}
