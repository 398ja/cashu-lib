...
public class MintInformation {
  ...
  @JsonProperty private String motd;

  @JsonProperty private Map<String, NutConfig> nuts = new HashMap<>();
  ...
  public static class NutConfig {
    ...
    @JsonProperty private Set<Method> methods = new HashSet<>();

    @JsonProperty private Boolean disabled;

    @JsonProperty private Boolean supported;
