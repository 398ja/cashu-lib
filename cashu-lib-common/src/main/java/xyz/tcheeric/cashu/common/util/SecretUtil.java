...
/**
 * Utility methods for converting between generic secret representations and {@link Secret}
 * implementations.
 */
public final class SecretUtil<T extends Secret> {
   ...
   *
   * <p>The input may be one of the following:
   *
   * <ul>
   *   <li>a {@link String} representing a {@link RandomStringSecret}
   *   <li>a {@link java.util.Map} describing a {@link WellKnownSecret} with a "kind" field
   *   <li>a {@link java.util.List} of the form {@code [kind, { ... }]} where the second element
   *       contains the fields of a {@link WellKnownSecret}
   * </ul>
   *
